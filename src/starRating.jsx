...
export default function StarRating({
  ...
  size,
  defaultRating,
  onRatingChange, //Take notes for further interview about this realization
}) {
      ...
      <div style={startContainerStyle}>
        {Array.from({ length: maxRating }, (_, i) => (
          <Star
            ...
            color={color}
            size={size}
          /> //Click 设置当前的state为当前的位置上，如果数组的序号
        ))}
      </div>
...
function Star({ onRate, filled, onMouseIn, onMouseOut, color, size }) {
  const starStyle = {
    width: `${size}px`,
    height: `${size}px`,
    display: "block",
